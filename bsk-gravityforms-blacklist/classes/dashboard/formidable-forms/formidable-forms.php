...
class BSK_GFBLCV_Dashboard_Formidable_Forms {
	...
	public $_bsk_gfblcv_OBJ_ff_entry = NULL;
	...
	public function __construct() {
		...
		require_once( BSK_GFBLCV_FREE_DIR.'classes/dashboard/formidable-forms/form-entry.php' );
		...
		$this->_bsk_gfblcv_OBJ_ff_entry = new BSK_GFBLCV_Dashboard_FF_Entry();

...
class BSK_GFBLCV_Dashboard_FF_Entry {
	
	function __construct() {
        if ( BSK_GFBLCV_Dashboard_Common::bsk_gfblcv_is_form_plugin_supported('FF') ) {
            add_action( 'frm_entry_shared_sidebar_middle', array( $this, 'bsk_gfblcv_ff_entry_add_email_to_list' ), 10, 1 );
        }
	}
	
    function bsk_gfblcv_ff_entry_add_email_to_list( $entry ) {
        ...
        $emails = array();
        foreach ( $entry->metas as $field_value ) {
        ...
        ?>
        <div class="frm_with_icons frm_no_print bsk-gfblcv-form-entry-actions-container">
            <h3>BSK Forms Blacklist Actions</h3>
            <div class="inside">
                <div class="misc-pub-section bsk-gfblcv-form-entry-action-section email-action-section">
                <span>Add Email to List</span>
                <?php 
                if ( count( $emails ) < 1 ) { 
                    ...
                    $anchor_html = '
                        <p>
                            <a href="javascript:void(0);" class="bsk-gfblcv-form-entry-add-item-to-list-select-save button button-secondary frm-button-secondary">Save</a>
                        </p>
                    ';
                ...
                <div class="misc-pub-section bsk-gfblcv-form-entry-action-section ip-action-section">
                    <span>Add IP to List</span>
                    <ul>
                        <li>
                    ...
                    <div class="bsk-gfblcv-form-entry-list-container">
                        ...
                        <p>
                            <a href="javascript:void(0);" class="bsk-gfblcv-form-entry-add-ip-to-list-select-save button button-secondary frm-button-secondary" data-ip="<?php echo esc_attr( $entry->ip ); ?>">Save</a>
                            <span class="bsk-gfbl-ajax-loader" style="display: none;"><?php echo BSK_GFBLCV_Pro::$ajax_loader; ?></span>
                        </p>
                        <?php } ?>
                        <p class="bsk-gfblcv-form-entry-add-to-list-error" style="color: #FF0000;display: none;"></p>
                        <p class="bsk-gfblcv-form-entry-add-to-list-success" style="color: #008800;display: none;"></p>

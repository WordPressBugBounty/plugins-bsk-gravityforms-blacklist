...
class BSK_GFBLCV_Dashboard_GF_Entry {

	function __construct() {

        if ( BSK_GFBLCV_Dashboard_Common::bsk_gfblcv_is_form_plugin_supported('GF') ) {
            add_filter( 'gform_entry_detail_meta_boxes', array( $this, 'bsk_gfblcv_gf_entry_actions_fun' ), 10, 3 );
        }
		
	}

    function bsk_gfblcv_gf_entry_actions_fun( $meta_boxes, $entry, $form ) {

        $meta_boxes['bsk_gfblcv_actions'] = array(
            'title'    => 'BSK Forms Blacklist',
            'callback' => array( $this, 'bsk_gfblcv_gf_entry_actions_call_back' ),
            'context'  => 'side',
        );
    ...
    function bsk_gfblcv_gf_entry_actions_call_back( $args ) {
        $form  = $args['form'];
        $entry = $args['entry'];
        ...
        ?>
        <div class="bsk-gfblcv-form-entry-actions-container">
            ...
            <div class="bsk-gfblcv-form-entry-action-section ip-action-section" style="margin-top: 40px;">
                ...
                <div class="bsk-gfblcv-form-entry-list-container">
                    ...
                    <p>
                        <a href="javascript:void(0);" class="button bsk-gfblcv-form-entry-add-ip-to-list-select-save" data-ip="<?php echo esc_attr( $entry['ip'] ); ?>">Save</a>
                    </p>
                    <?php } ?>
                    <p class="bsk-gfblcv-form-entry-add-to-list-error" style="color: #FF0000;display: none;"></p>
                    <p class="bsk-gfblcv-form-entry-add-to-list-success" style="color: #008800;display: none;"></p>
